    ...
    <div>
        <div class="max-w-xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="POST" action="{{ route('employee.update') }}" enctype="multipart/form-data"  autocomplete="off">
                    <input type="hidden" name="id" value="{{ $employee['id'] }}">
                    @csrf
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-2 bg-white sm:p-6">
                            <label for="name" class="block font-medium text-sm text-gray-700">{{__('Name')}}</label>
                            <input type="text" name="name" id="name" value="{{ $employee['name'] }}" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-2 bg-white sm:p-6">
                            ...
                            <input type="text" name="email" id="email" value="{{ $employee['email'] }}" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-2 bg-white sm:p-6">
                            ...
                            <input type="text" name="contact" id="contact" value="{{ $employee['contact'] }}" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-2 bg-white sm:p-6">
                            ...
                            <input type="text" name="designation" id="designation" value="{{ $employee['designation'] }}" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('name', '') }}" required />
                            @error('designation')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="px-4 py-2 bg-white sm:p-6">
                            ...
                            <input type="text" name="city" id="city" value="{{ $employee['city'] }}" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('name', '') }}" required />
                            @error('city')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
